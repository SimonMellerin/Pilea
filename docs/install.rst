...
.. code-block:: sh
    ...
    bin/console aeneria:install

Ajouter une premier utilisateur et lui donner les droits administrateur :

.. code-block:: sh

    bin/console aeneria:user:add [username] [password]
    bin/console aeneria:user:grant [username]

Mettre en place le cron :

.. code-block:: sh

    echo "*/10  *  *  *  * [user] /[app_folder]/bin/console aeneria:fetch-data false" > /etc/cron.d/aeneria
